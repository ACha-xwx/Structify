...
while IFS= read -r line || [[ -n "$line" ]]; do
  case "$line" in
    ...
    MEMORY_RESERVE_MB=*) line="MEMORY_RESERVE_MB=128" ;;
    MIN_AVAILABLE_MEMORY_MB=*) line="MIN_AVAILABLE_MEMORY_MB=1024" ;;
    MYSQL_MEMORY_LIMIT=*) line="MYSQL_MEMORY_LIMIT=320m" ;;
    MYSQL_MEMORY_RESERVATION=*) line="MYSQL_MEMORY_RESERVATION=256m" ;;
    NODE_MEMORY_LIMIT=*) line="NODE_MEMORY_LIMIT=192m" ;;
    NODE_MEMORY_RESERVATION=*) line="NODE_MEMORY_RESERVATION=128m" ;;
    NODE_MAX_OLD_SPACE_MB=*) line="NODE_MAX_OLD_SPACE_MB=128" ;;
    SPRING_MEMORY_LIMIT=*) line="SPRING_MEMORY_LIMIT=320m" ;;
    SPRING_MEMORY_RESERVATION=*) line="SPRING_MEMORY_RESERVATION=256m" ;;
